      ...
      <Container maxW={"3xl"}>
        ...
        >
          <Heading
            ...
            lineHeight={"110%"}
          >
            ZkDegree - Your Gateway to Verifiable Academic Credentials
          </Heading>
          <Text color={"gray.500"}>
